...
# Ensure custom branding is synced to backend static folder
echo "Syncing branding assets..."
cp static/favicon.png backend/open_webui/static/favicon.png 2>/dev/null || true
cp static/logo.png backend/open_webui/static/logo.png 2>/dev/null || true
cp static/splash.png backend/open_webui/static/splash.png 2>/dev/null || true
cp static/splash-dark.png backend/open_webui/static/splash-dark.png 2>/dev/null || true
cp static/favicon.ico backend/open_webui/static/favicon.ico 2>/dev/null || true
cp static/favicon.svg backend/open_webui/static/favicon.svg 2>/dev/null || true
